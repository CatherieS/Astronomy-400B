...
# and simulation snapshot
    ...
    def COMdefine(self,a,b,c,m):
        ...
        a_com = sum((self.x*self.m)/self.m)
        # ycomponent Center of mass
        b_com = sum((self.y*self.m)/self.m)
        # zcomponent Center of mass
        c_com = sum((self.z*self.m)/self.m)
    ...
    def COM_V(self, x_COM, y_COM, z_COM):
        ...
        xV = self.data['vx'][self.index]
        yV = self.data['vy'][self.index]
        zV = self.data['vz'][self.index]
        rV = r_new = np.sqrt(xV**2 + yV**2 + zV**2)
        ...
        # write your own code below
        vx_COM, vy_COM, vz_COM = np.array([vx_new, vy_new, vz_new])
        
        # create an array to store the COM velocity
        # write your own code below
        v_COM = np.round(vx_COM,3)*u.kpc
